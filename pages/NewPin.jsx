...
function NewPin() {
  ...
  // Assuming wishlistId is passed as a query parameter or obtained from context
  const { wishlistId } = useParams(); // Get wishlist ID from URL params
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      // API call to save the new pin
      await axios.post(`http://127.0.0.1:5000/wishlists/${wishlistId}/items`, {
        name: title,
